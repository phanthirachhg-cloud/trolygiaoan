...
<div class="main-header">
    ...
    <p>Tác giả: Phàn Thị Rạch - Trường TH Thông Nguyên - ĐT: 0384 409 758</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Phàn Thị Rạch - Trường TH Thông Nguyên - ĐT: 0384 409 758</div>", unsafe_allow_html=True)
